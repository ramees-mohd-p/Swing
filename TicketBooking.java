...
public class TicketBooking {
	...
	private void initialize() {
		...
		comboBox.setModel(new DefaultComboBoxModel(new String[] {"Kozhikkode", "Malappuram", "Ernakkulam"}));
		comboBox.setBounds(10, 181, 89, 20);
		panel_2.add(comboBox);
		
		JComboBox comboBox_1 = new JComboBox();
		comboBox_1.setModel(new DefaultComboBoxModel(new String[] {"Kozhikkode", "Malappuram", "Ernakkulam"}));
